...
{ 
      ...
      $smtp_host         = "mail.phpcoban.hocwebgiare.com";//Dia chi mail server 
      $admin_email         = "testmail@phpcoban.hocwebgiare.com";//User duoc khai bao tren mail server 
      $smtp_username     = "testmail@phpcoban.hocwebgiare.com";//User duoc khai bao tren mail server 
      $smtp_password     = "phpcoban";//Pass cua email nay 
